...
const Projects = () => {
    ...
    const etudesProjects = projectsData.filter(p => p.category === "Études").slice(0, 2);
    const controlProjects = projectsData.filter(p => p.category === "Contrôle et Surveillance").slice(0, 2);
          ...
          {displayedProjects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                ...
                <h4 className="text-2xl font-bold text-white mb-2 line-clamp-1">{project.title}</h4>
